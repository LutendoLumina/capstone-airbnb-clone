...
import UserListingDetailsPage from "./pages/Listings/UserListingDetailsPage";
    ...
    <BrowserRouter>
      ...
      <main style={{ padding: "10px" }}>
        <Routes>
          ...
          {/* <Route path="/listing/:id" element={<UserListingDetailsPage />} />
          <Route path="/my-trips" element={currentUser ? <UserReservationsPage /> : <Navigate to="/login" replace />} /> */}
